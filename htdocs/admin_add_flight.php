    ...
    <div class="row">
        <form action="admin_add_flight.php" method="post" id="addFlightPlan">
            <div class="form-group">
                ...
                <input type="text" name="origin" class="form-control" pattern="[A-Za-z]{1,}" id="origin" size="50"
                       value="<?php if (isset($_POST['origin'])) echo $_POST['origin']; ?>" required>
            </div>
			<div class="form-group">
                <label for="destination">Destination:</label>
                <input type="text" name="destination" class="form-control" pattern="[A-Za-z]{1,}" id="destination" size="50"
